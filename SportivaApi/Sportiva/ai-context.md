...
- Files matching these patterns are excluded: ai-context.md, repomix-output.xml, keys/**, wwwroot/**, **/*.xml, tree.txt, **/*.csproj, **/*.sln, **/*.user, **/*.designer.cs, **/*.g.cs, **/bin/**, **/obj/**, **/.vs/**, **/Migrations/**
...
Contracts/Shared/Enums/ReviewBookingRequest.cs
Contracts/Shared/Enums/SportTypeDto.cs
Contracts/Shared/Enums/SubscriptionStatusDto.cs
...
Contracts/Subscriptions/CreateSubscriptionPlanRequest.cs
Contracts/Subscriptions/SubscriptionPaymentSummary.cs
Contracts/Subscriptions/SubscriptionPlanResponse.cs
Contracts/Subscriptions/UpdateSubscriptionPlanRequest.cs
Contracts/TimeSlots/CreateTimeSlotRequest.cs
Contracts/TimeSlots/SetTimeSlotsAvailabilityRequest.cs
...
Controllers/ClubSubscriptionsController.cs
...
Errors/ClubSubscriptionErrors.cs
Errors/CommentErrors.cs
Errors/CourtErrors.cs
Errors/MembershipUpgradeErrors.cs
Errors/PostErrors.cs
Errors/ProfileErrors.cs
Errors/ReviewErrors.cs
Errors/SubscriptionPlanErrors.cs
Errors/TimeSlotErrors.cs
...
Services/Implementation/BookingService.cs
Services/Implementation/ClubService.cs
Services/Implementation/ClubSubscriptionService.cs
Services/Implementation/CommentService.cs
Services/Implementation/CourtService.cs
Services/Implementation/EmailService.cs
Services/Implementation/MembershipUpgradeService.cs
Services/Implementation/PostService.cs
Services/Implementation/ProfileService.cs
Services/Implementation/ReviewService.cs
Services/Implementation/SubscriptionPlanService.cs
Services/Implementation/TimeSlotService.cs
Settings/GitHubOAuthOptions.cs
Settings/GoogleOAuthOptions.cs
Settings/MailSettings.cs
Settings/TimeSlotOptions.cs
sportiva-api-reference.html
```

# Files

## File: Contracts/Shared/Enums/ReviewBookingRequest.cs
```csharp
...
## File: Contracts/Shared/Enums/SubscriptionStatusDto.cs
```csharp
namespace Sportiva.Contracts.Shared.Enums;

/// <summary>
/// Data transfer object for SubscriptionStatus enum.
/// </summary>
...
## File: Contracts/Subscriptions/CreateSubscriptionPlanRequest.cs
```csharp
...
## File: Contracts/Subscriptions/UpdateSubscriptionPlanRequest.cs
```csharp
namespace Sportiva.Contracts.Subscriptions;
...
## File: Contracts/TimeSlots/SetTimeSlotsAvailabilityRequest.cs
```csharp
...
## File: Controllers/ClubSubscriptionsController.cs
```csharp
using Sportiva.Contracts.Common;
...
## File: Controllers/CourtsController.cs
```csharp
using Sportiva.Contracts.Common;
...
## File: Controllers/MembershipUpgradesController.cs
```csharp
// Controllers/MembershipUpgradesController.cs
using Sportiva.Contracts.Common;
...
## File: Controllers/SubscriptionPlansController.cs
```csharp
using Sportiva.Contracts.Subscriptions;
using Sportiva.Extensions;
using Sportiva.Services;
...
## File: Controllers/TimeSlotsController.cs
```csharp
...
## File: Errors/ClubSubscriptionErrors.cs
```csharp
namespace Sportiva.Errors;
    ...
    ILogger<BookingService> logger) : IBookingService
{
        ...
        string userId, CreateBookingRequest request, CancellationToken ct = default)
    {
        try
        {
            ...
            // TODO: إشعار صاحب الملعب (INotificationService) إن فيه طلب حجز جديد مستني رده.
        ...
        string ownerId, string bookingId, ReviewBookingRequest request, CancellationToken ct = default)
    {
        try
        {
            ...
            // TODO: إشعار العضو (INotificationService) إن طلبه اتقبل أو اتّرفض.
        ...
        string userId, string bookingId, CancellationToken ct = default)
    {
        try
        {
            ...
            // TODO: إشعار الطرف التاني (INotificationService) إن الحجز اتلغى.
...
## File: Services/Implementation/ClubSubscriptionService.cs
```csharp
using Sportiva.Contracts.Common;
using Sportiva.Contracts.Shared.Enums;
using Sportiva.Contracts.Shared.Summaries;
...
## File: Services/Implementation/CourtService.cs
```csharp
using Hangfire;
using Sportiva.Contracts.Common;
using Sportiva.Contracts.Courts;
...
## File: Services/Implementation/MembershipUpgradeService.cs
```csharp
using Sportiva.Contracts.Common;
using Sportiva.Contracts.Memberships;
using Sportiva.Contracts.Shared.Enums;
...
## File: Services/Implementation/ReviewService.cs
```csharp
using Sportiva.Contracts.Common;
using Sportiva.Contracts.Reviews;
using Sportiva.Contracts.Shared.Enums;
...
## File: Services/Implementation/SubscriptionPlanService.cs
```csharp
using Sportiva.Contracts.Subscriptions;
...
## File: Services/Implementation/TimeSlotService.cs
```csharp
...
## File: Settings/TimeSlotOptions.cs
```csharp
                ...
                select new ClubResponse(
                    ...
                    ActiveSubscription: c.Subscriptions
                        ...
                        .Select(s => new ClubSubscriptionSummary(
                            s.Id,
                            new SubscriptionPlanSummary(s.PlanId, s.Plan.Name, s.Plan.Price, s.Plan.MaxCourts),
                            s.StartDate,
                            s.EndDate,
                            true))
                        .FirstOrDefault(),
...
## File: Errors/MembershipUpgradeErrors.cs
```csharp
namespace Sportiva.Errors;
...
## File: Errors/SubscriptionPlanErrors.cs
```csharp
namespace Sportiva.Errors;
...
public interface IBookingService
{
    ...
    Task<Result<BookingResponse>> ReviewBookingAsync(
    string ownerId, string bookingId, ReviewBookingRequest request, CancellationToken ct = default);
...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddOptions<MailSettings>()
            ...
            .ValidateOnStart();
        services.Configure<TimeSlotOptions>(
    configuration.GetSection(TimeSlotOptions.SectionName));
        return services;
    }
