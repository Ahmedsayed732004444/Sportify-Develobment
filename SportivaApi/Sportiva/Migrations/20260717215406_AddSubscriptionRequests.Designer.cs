...
namespace Sportiva.Migrations
{
    ...
    [Migration("20260717215406_AddSubscriptionRequests")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            UserId = "0191b2c3-c4fc-752e-9d95-40b30fa7a9b7",
                            RoleId = "0191a4b6-c4fc-752e-9d95-40b5e4e68054"
                        });
                });
            ...
            modelBuilder.Entity("Sportiva.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "647f9fdc-4677-473b-a656-4deb7000478c",
                            ConcurrencyStamp = "fb32d7a4-c53f-421d-bbd3-2b00dd57fa1d",
                            IsDefault = false,
                            IsDeleted = false,
                            Name = "Owner",
            ...
            modelBuilder.Entity("Sportiva.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "0191b2c3-c4fc-752e-9d95-40b30fa7a9b7",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0191a4b6-c4fc-752e-9d95-40b42a925b8f",
                            CreatedAt = new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            ...
                            LastName = "Admin",
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@SPORTIFY.COM",
                            NormalizedUserName = "ADMIN@SPORTIFY.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEF+nP3oIur8ZNGiku2rjPpIZ0zeD9A6/kdsn0J6C2n7YJtRyMA2iHrvr5W+1D2i++w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "55BF92C9EF0249CDA210D85D1A851BD0",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Sportiva.Entities.SubscriptionRequest", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Sportiva.Entities.TimeSlot", b =>
                {
                    ...
                    b.HasIndex("CourtId", "Day", "StartTime")
                        .IsUnique();
            ...
            modelBuilder.Entity("Sportiva.Entities.CommentReaction", b =>
                {
                    b.HasOne("Sportiva.Entities.PostComment", "Comment")
                        .WithMany("Reactions")
            ...
            modelBuilder.Entity("Sportiva.Entities.Message", b =>
                {
                    b.HasOne("Sportiva.Entities.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sportiva.Entities.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Sportiva.Entities.Notification", b =>
                {
                    b.HasOne("Sportiva.Entities.ApplicationUser", "Actor")
                        .WithMany()
                        .HasForeignKey("ActorId");

                    b.HasOne("Sportiva.Entities.ApplicationUser", "Recipient")
                        .WithMany()
            ...
            modelBuilder.Entity("Sportiva.Entities.ReplyReaction", b =>
                {
                    b.HasOne("Sportiva.Entities.CommentReply", "Reply")
                        .WithMany("Reactions")
            ...
            modelBuilder.Entity("Sportiva.Entities.TournamentMatch", b =>
                {
                    b.HasOne("Sportiva.Entities.ApplicationUser", "Player1")
                        .WithMany()
                        .HasForeignKey("Player1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sportiva.Entities.ApplicationUser", "Player2")
                        .WithMany()
                        .HasForeignKey("Player2Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sportiva.Entities.Tournament", "Tournament")
                        .WithMany("Matches")
                        .HasForeignKey("TournamentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sportiva.Entities.ApplicationUser", "Winner")
                        .WithMany()
            ...
            modelBuilder.Entity("Sportiva.Entities.UserFollow", b =>
                {
                    b.HasOne("Sportiva.Entities.ApplicationUser", "Follower")
                        .WithMany("Following")
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sportiva.Entities.ApplicationUser", "Following")
                        .WithMany("Followers")
